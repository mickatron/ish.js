describe('core', function() {
	...
	describe("ish('selector').dimension()", function() {
		...
		it('percentages - should have a width of 280px', function() {
		...
		it('can get properties of an element with display:none', function() {
			var $target = ish('.styled');
		...
		it('can get properties of an element with display:none', function() {
			var $target = ish('.styled-margin');
			expect($target.height(true, true)).toEqual(120);
			expect($target.width(true, true)).toEqual(240);
		});
...
*/
	...
	describe("ish('selector').offset()", function() {
		...
		it('should get offset value', function() {
			var $target = ish('.styled-positioned');
			expect($target.offset().left).toEqual(30);
			expect($target.offset().top).toEqual(15);	
		});
	});
});